...
try:
    ...
    def cal_multi_col(row):
     ...
     #################
    #TODO добавить проверку соединения с СУБД. Если пройдено, то запускать дальнейшее выполнение кода
    #TODO разобраться с rytry и не записывать пустой датафрейм
    ...
    #TODO сохранять итоговый файл без индекса
    try:
